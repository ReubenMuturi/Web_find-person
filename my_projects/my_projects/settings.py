...
SECRET_KEY = 'django-insecure-dj_lw_d!8q^%igix5$+9rbo0e%6_ui+4o+!e1o3o!5xizz8^lc'
...
INSTALLED_APPS = [
    ...
    'profiles',  # Add your new app here
]
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'your_database_password',  # Replace with your password
        'HOST': 'localhost',
        'PORT': '5432',
...
# For development, you can add the following to collect static files (usually not needed in production):
STATICFILES_DIRS = [
    BASE_DIR / 'static',
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'palamer61@gmail.com'
